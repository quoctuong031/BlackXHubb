...
do local GUI = game.CoreGui:FindFirstChild("GUI");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(51,255,62)
   end 
end
...
function Update:Window(text,logo,keybind)
	...
	Hub.Position = UDim2.new(0, 95, 0, 0)
	Hub.Size = UDim2.new(0, 81, 0, 27)
	Hub.Font = Enum.Font.GothamSemibold
	Hub.Text = "1"
	Hub.TextColor3 = Color3.fromRGB(230,0,0)
	Hub.TextSize = 17.000
	...
	function uitab:Tab(text)
		...
		function main:Button(text,callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(230,0,0)
		...
		function main:Toggle(text,config,callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(230,0,0)
		...
		function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(230,0,0)
			...
			bar1.Name = "bar1"
			bar1.Parent = bar
			bar1.BackgroundColor3 = Color3.fromRGB(230,0,0)
			...
			slidervalue.BackgroundColor3 = Color3.fromRGB(230,0,0)
		...
		function main:Textbox(text,disappear,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(230,0,0)
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(230,0,0)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(230,0,0)
		...
		function main:Line()
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(230,0,0)
...
if game.PlaceId == 2753915549 then
    ...
    function CheckQuest() 
        ...
        if World1 then
            ...
            elseif MyLevel == 15 or MyLevel <= 29 and _G.Farm_Mode == "Normal" then
                Mon = "Gorilla [Lv. 20]"
                LevelQuest = 2
                NameQuest = "JungleQuest"
                NameMon = "Gorilla"
                CFrameQuest = CFrame.new(-1598.08911, 35.5501175, 153.377838, 0, 0, 1, 0, 1, -0, -1, 0, 0)
            elseif MyLevel == 15 or MyLevel <= 16 and _G.Farm_Mode == "Fast" then
                Mon = "Gorilla [Lv. 20]"
                LevelQuest = 2
                NameQuest = "JungleQuest"
                NameMon = "Gorilla"
                CFrameQuest = CFrame.new(-1598.08911, 35.5501175, 153.377838, 0, 0, 1, 0, 1, -0, -1, 0, 0)
            elseif MyLevel == 16 or MyLevel <= 29 and _G.Farm_Mode == "Fast" then
                Mon = "Shanda [Lv. 475]"
                LevelQuest = 2
                NameQuest = "JungleQuest"
                NameMon = "Gorilla"
                CFrameQuest = CFrame.new(-7750.50391, 5577.92236, -488.500214, 0.999135256, 9.21268963e-08, 0.0415787585, -9.31971442e-08, 1, 2.3801956e-08, -0.0415787585, -2.76563945e-08, 0.999135256)
            ...
            elseif MyLevel == 30 or MyLevel <= 99 and _G.Farm_Mode == "Fast" then
    ...
    elseif game:GetService("Workspace").Enemies:FindFirstChild("Royal Soldier [Lv. 550]") then
                ...
                NameQuest = "JungleQuest"
                NameMon = "Gorilla"
                CFrameQuest = CFrame.new(-7751.32422, 5633.50098, -1567.42346, -0.944359183, -7.19732967e-08, -0.328916073, -6.74941205e-08, 1, -2.5035586e-08, 0.328916073, -1.44268386e-09, -0.944359183)
                if (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 1500 then
            local args = {
                [1] = "requestEntrance",
                [2] = Vector3.new(-7894.61767578125, 5547.1416015625, -380.29119873046875)
            ...
            elseif MyLevel == 30 or MyLevel <= 39 and _G.Farm_Mode == "Normal" then
                Mon = "Pirate [Lv. 35]"
                LevelQuest = 1
                NameQuest = "BuggyQuest1"
                NameMon = "Pirate"
                CFrameQuest = CFrame.new(-1141.07483, 4.10001802, 3831.5498, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627)
            elseif MyLevel == 40 or MyLevel <= 59 and _G.Farm_Mode == "Normal" then
                Mon = "Brute [Lv. 45]"
                LevelQuest = 2
                NameQuest = "BuggyQuest1"
                NameMon = "Brute"
                CFrameQuest = CFrame.new(-1141.07483, 4.10001802, 3831.5498, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627)
            elseif MyLevel == 60 or MyLevel <= 74 and _G.Farm_Mode == "Normal" then
                Mon = "Desert Bandit [Lv. 60]"  
                LevelQuest = 1
                NameQuest = "DesertQuest"
                NameMon = "Desert Bandit"
                CFrameQuest = CFrame.new(894.488647, 5.14000702, 4392.43359, 0.819155693, -0, -0.573571265, 0, 1, -0, 0.573571265, 0, 0.819155693)
            elseif MyLevel == 75 or MyLevel <= 89 and _G.Farm_Mode == "Normal" then
                Mon = "Desert Officer [Lv. 70]"
                LevelQuest = 2
                NameQuest = "DesertQuest"
                NameMon = "Desert Officer"
                CFrameQuest = CFrame.new(894.488647, 5.14000702, 4392.43359, 0.819155693, -0, -0.573571265, 0, 1, -0, 0.573571265, 0, 0.819155693)
            elseif MyLevel == 90 or MyLevel <= 99 and _G.Farm_Mode == "Normal" then
...
elseif MyLevel == 2300 or MyLevel <= 2324 then
                ...
                CFrameQuest = CFrame.new(70.1537399, 70.7464752, -12314.791, -0.379967898, 3.45996618e-08, 0.924999654, 1.30620608e-08, 1, -3.20394697e-08, -0.924999654, -9.15678783e-11, -0.379967898)
elseif MyLevel == 2325 or MyLevel <= 2349 then
                Mon = "Chocolate Bar Battler [Lv. 2325]"
                QN = "ChocQuest1"
                LevelQuest = 2
                NameMon = "Chocolate Bar Battler"
                CFrameQuest = CFrame.new(705.924255, 60.3350067, -12596.3975, 0.895663321, -2.54097454e-08, 0.444732726, 6.13893008e-08, 1, -6.64992612e-08, -0.444732726, 8.68627836e-08, 0.895663321)
elseif MyLevel == 2350 or MyLevel <= 2374 then
                Mon = "Sweet Thief [Lv. 2350]"
                NameQuest = "ChocQuest2"
                LevelQuest = 1
                NameMon = "Sweet Thief"
                CFrameQuest = CFrame.new(108.781532, 89.2844696, -12488.5498, 0.979075432, 7.09107617e-09, -0.203497529, -2.50525503e-08, 1, -8.56878231e-08, 0.203497529, 8.89929765e-08, 0.979075432)
elseif MyLevel == 2375 or MyLevel <= 2399 then
                Mon = "Candy Rebel [Lv. 2375]"
                NameQuest = "ChocQuest2"
                LevelQuest = 2
                NameMon = "Candy Rebel"
                CFrameQuest = CFrame.new(133.034821, 77.2845383, -12879.082, 0.816193461, -2.26455068e-08, 0.577778697, 3.96975786e-08, 1, -1.68843179e-08, -0.577778697, 3.67172852e-08, 0.816193461)
...
spawn(function()
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.AutoFarm or _G.TeleportIsland then
...
local Library = Update:Window("BlackX Hub","6023426909",Enum.KeyCode.RightControl);
Main = Library:Tab("Main","6023426909")

Main:Seperator("Welcome To BlackX Hub")

local locallv = Main:Label("Level")
...
local localrace = Main:Label("Race")
...
local localbeli = Main:Label("Beli")
...
local localfrag = Main:Label("Fragment")
...
local localstat = Main:Label("Stats Points")
...
local localbountyhornor = Main:Label("Bounty")
...
local localDevil = Main:Label("Devil Fruit")
...
Main:Dropdown("Select Farm Mode",{"Normal","Fast"},function(value)
    _G.Farm_Mode = value
end)
...
Main:Toggle("Auto Super Fast Attack",false,function(x)
    _G.AutoFastAttack = x
end)
...
spawn(function()
  ...
  Main:Seperator("Fighting Style")
    ...
    Main:Toggle("Auto Superhuman",false,function(x)
    _G.AutoSuperHuman = x
end)
...
Main:Toggle("Auto God Human",false,function(value)
...
Main:Toggle("Auto Farm DF Mastery",false,function(value)
...
Main:Toggle("Auto Fish Trail (Not work)",false,function(value)
...
Main:Seperator("Auto SoulGuitar")
...
Main:Seperator("Law Raid")

Main:Toggle("Auto Law Boss",false,function(value)
    _G.AutoBossLaw = value
    StopTween(_G.AutoBossLaw)
end)

Main:Toggle("Auto Buy Chip",false,function(value)
...
Main:Toggle("Auto Advance Dungeon",false,function(value)
...
Main:Seperator("Auto Farm ganaral")

local BoneFarm = Main:Toggle("Auto Farm Bone",false,function(value)
    ...
    spawn(function()
    while task.wait() do
        if _G.AutoFarmBone and _G.SelectWeapon then
            pcall(function()
                ...
                for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do 
                    if v.Name == "Reborn Skeleton [Lv. 1975]" then
                        topos(v.HumanoidRootPart.CFrame * CFrame.new(_G.X,_G.Y,_G.Z))
...
spawn(function()
    while task.wait() do
        if _G.BringMonster and _G.AutoFarmBone then
            pcall(function()
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
local HeartsFarm = Main:Toggle("Auto Farm Hearts",false,function(value)
    _G.AutoFarmHearts = value
    StopTween(_G.AutoFarmHearts)
end)

spawn(function()
    while wait() do 
        if _G.AutoFarmHearts and World3 then
            pcall(function()
				if game:GetService("Workspace").Enemies:FindFirstChild("Snow Demon [Lv. 2425]") or game:GetService("Workspace").Enemies:FindFirstChild("Candy Pirate [Lv. 2400]") then
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == "Snow Demon [Lv. 2425]" or v.Name == "Candy Pirate [Lv. 2400]" then
							if v.Humanoid.Health > 0 then
								repeat task.wait()
                                    AutoHaki()
                                    EquipWeapon(_G.SelectWeapon)
								...
								until not _G.AutoFarmHearts or v.Humanoid.Health <= 0 or not v.Parent
							end
						end
					end
				else
					StartMagnetHeartsMon = false
                    TP1(CFrame.new(-1077.31726, 91.997963, -14462.0176, 0.997046232, -6.44938325e-08, -0.0768033788, 6.90259014e-08, 1, 5.63541001e-08, 0.0768033788, -6.14890681e-08, 0.997046232))                   
				end
			end)
		end
	end
...
Main:Toggle("Auto Farm Observation",false,function(value)
...
Main:Toggle("Auto Farm Observation Hop",false,function(value)
...
Main:Toggle("Auto Saber Hop",false,function(value)
...
Main:Toggle("Auto Legendary Sword",false,function(value)
...
Main:Toggle("Auto Legendary Sword Hop",false,function(value)
    _G.AutoBuyLegendarySword_Hop = value
end)

Main:Seperator("Enchancement Colour")

Main:Toggle("Auto Enchancement Colour",false,function(value)
    _G.AutoBuyEnchancementColour = valua
end)

Main:Toggle("Auto Enchancement Hop",false,function(value)
        ...
        if _G.TeleportIsland == true then
            repeat wait()
                ...
                elseif _G.SelectIsland == "Candy Island" then
                    topos(CFrame.new(-1077.31726, 91.997963, -14462.0176, 0.997046232, -6.44938325e-08, -0.0768033788, 6.90259014e-08, 1, 5.63541001e-08, 0.0768033788, -6.14890681e-08, 0.997046232))
                end
...
T:Seperator("Race V4")
    ...
    T:Button("Teleport To Timple Of Time",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
T:Button("Teleport To Lever Pull",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

T:Button("Teleport To Acient One (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   T:Button("Unlock Lever.", function()
T:Notify("Unlocked")
...
T:Button("Clock Acces.", function()
    game:GetService("Workspace").Map["Temple of Time"].DoNotEnter:Remove()
    game:GetService("Workspace").Map["Temple of Time"].ClockRoomExit:Remove()
end)

T:Toggle("Disabled Inf Stairs", nil, function(value)
	game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value
end)
   T:Line()
 
 T:Button("Teleport Cyborg Door (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
 T:Button("Teleport Fish Door (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  T:Button("Teleport Ghoul Door (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  T:Button("Teleport Human Door (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  T:Button("Teleport Mink Door (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  T:Button("Teleport Sky Door (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)
  
  T:Line()
  
  T:Button("Teleport To Safe Zone When Pvp (Must Be in Temple Of Time!)",function()
  topos(CFrame.new(28273.0859375, 14896.5078125, 157.42063903808594))
  end)
  
  T:Button("Teleport Pvp Zone (Must Be in Temple Of Time!)",function()
...
DevilFruit = Library:Tab("DevilFruit")
...
Misc:Button("SetScreen for kaiton",function()
    __Config = {
      ['Inventory'] = {
         ['Fillter'] = {
...
Misc:Button("Destroy SetScreen",function()
    __Config = {
      ['Inventory'] = {
         ['Fillter'] = {
...
Misc:Toggle("ESP Island",IslandESP,function(value)
    IslandESP = value
